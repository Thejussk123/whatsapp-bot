...
module.exports = {
    VERSION: 'V1.0.2',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/E6TTJDw.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '➳ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝❥⃝꣘എശ്വ෬ൄ✦𝆺𝅥🌿🪶⟵⃪͢_;🇾🇪⃝᳄അലാവുദ്ധീൻ ᳀മാസ്സ്★ᬏ➣;918129927512;https://i.imgur.com/E6TTJDw.jpeg;https://chat.whatsapp.com/CoyDq2bXKMzEhS27ttAX7U',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || '➳ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝❥⃝꣘എശ്വ෬ൄ✦𝆺𝅥🌿🪶⟵⃪͢_',
    ...
    SUDO: process.env.SUDO || '917561823024,0',
